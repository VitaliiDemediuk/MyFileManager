...
//File's standard operations
    ...
    virtual bool RenameFile(const QString &path, const QString &new_name, QWidget *parent) const = 0;
...
//Directory's standard operations
    ...
    virtual bool RenameDir(const QString &path, const QString &new_name, QWidget *parent) const = 0;
